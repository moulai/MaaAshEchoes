...
- **日常-午后茶憩-茶憩角色 1**：与指定的第一个角色进行茶憩互动，**请创建或修改`resource/image/edit/午后茶憩_茶憩角色1.png`以指定角色**，详见下方的“使用说明”。
- **日常-午后茶憩-茶憩角色 2**：同上，通过**创建或修改`resource/image/edit/午后茶憩_茶憩角色2.png`**以指定第二个角色。
- **日常-午后茶憩-茶憩角色 3**：同上，通过**创建或修改`resource/image/edit/午后茶憩_茶憩角色3.png`**以指定第三个角色。
